...
ALTER TABLE "queue_metric_snapshots" ADD CONSTRAINT "queue_metric_snapshots_redis_instance_id_redis_instances_id_fk" FOREIGN KEY ("redis_instance_id") REFERENCES "public"."redis_instances"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
